const SURVEY_DATA = [
  ...
  { code: "ETH7", question: "ETH7: Moral truths are accessible through common sense, revelation, or reason", scores: { "Strongly Disagree": {ETH: -1}, "Disagree": {ETH: -0.5}, "Neutral": {ETH: 0}, "Agree": {ETH: 0.5}, "Strongly Agree": {ETH: 1} } },
  ...
  { code: "HN5", question: "HN5: We should work to create the perfect society", scores: { "Strongly Disagree": {HN: -1}, "Disagree": {HN: -0.5}, "Neutral": {HN: 0}, "Agree": {HN: 0.5}, "Strongly Agree": {HN: 1} } },
  { code: "HN6", question: "HN6: We are all born with an innate set of ideas", scores: { "Strongly Disagree": {HN: -1}, "Disagree": {HN: -0.5}, "Neutral": {HN: 0}, "Agree": {HN: 0.5}, "Strongly Agree": {HN: 1} } },
  ...
  // --- TRIBALISM ---
  { code: "TRB1", question: "TRB1: We have a responsibility to care for strangers", scores: { "Strongly Disagree": {TRB: -1}, "Disagree": {TRB: -0.5}, "Neutral": {TRB: 0}, "Agree": {TRB: 0.5}, "Strongly Agree": {TRB: 1} } },
  { code: "TRB2", question: "TRB2: Our most important responsibility is towards our own community", scores: { "Strongly Disagree": {TRB: -1}, "Disagree": {TRB: -0.5}, "Neutral": {TRB: 0}, "Agree": {TRB: 0.5}, "Strongly Agree": {TRB: 1} } },
  ...
  { code: "TRB6", question: "TRB6: Our community has natural enemies", scores: { "Strongly Disagree": {TRB: -1}, "Disagree": {TRB: -0.5}, "Neutral": {TRB: 0}, "Agree": {TRB: 0.5}, "Strongly Agree": {TRB: 1} } },
  { code: "TRB7", question: "TRB7: It is important for membership in a community to be exclusive", scores: { "Strongly Disagree": {TRB: -1}, "Disagree": {TRB: -0.5}, "Neutral": {TRB: 0}, "Agree": {TRB: 0.5}, "Strongly Agree": {TRB: 1} } },
  ...
  // --- RELIGION ---
  { code: "REL1", question: "REL1: There are certain things that cannot be explained without religion", scores: { "Strongly Disagree": {REL: -1}, "Disagree": {REL: -0.5}, "Neutral": {REL: 0}, "Agree": {REL: 0.5}, "Strongly Agree": {REL: 1} } },
  { code: "REL2", question: "REL2: There is an innate meaning to life", scores: { "Strongly Disagree": {REL: -1}, "Disagree": {REL: -0.5}, "Neutral": {REL: 0}, "Agree": {REL: 0.5}, "Strongly Agree": {REL: 1} } },
  { code: "REL3", question: "REL3: Science is the only universally valid source to understand the world", scores: { "Strongly Disagree": {REL: -1}, "Disagree": {REL: -0.5}, "Neutral": {REL: 0}, "Agree": {REL: 0.5}, "Strongly Agree": {REL: 1} } },
  { code: "REL4", question: "REL4: Prayer has had a real influence on my life", scores: { "Strongly Disagree": {REL: -1}, "Disagree": {REL: -0.5}, "Neutral": {REL: 0}, "Agree": {REL: 0.5}, "Strongly Agree": {REL: 1} } },
  { code: "REL5", question: "REL5: Supernatural forces have played a major role in human history", scores: { "Strongly Disagree": {REL: -1}, "Disagree": {REL: -0.5}, "Neutral": {REL: 0}, "Agree": {REL: 0.5}, "Strongly Agree": {REL: 1} } },
  { code: "REL6", question: "REL6: Morality cannot be grounded without a divine source", scores: { "Strongly Disagree": {REL: -1, ETH: -1}, "Disagree": {REL: -0.5, ETH: -0.5}, "Neutral": {REL: 0, ETH: 0}, "Agree": {REL: 0.5, ETH: 0.5}, "Strongly Agree": {REL: 1, ETH: 1} } },
  { code: "REL7", question: "REL7: Religion is an outdated concept", scores: { "Strongly Disagree": {REL: -1}, "Disagree": {REL: -0.5}, "Neutral": {REL: 0}, "Agree": {REL: 0.5}, "Strongly Agree": {REL: 1} } },
  { code: "REL8", question: "REL8: Human life does not end with physical death", scores: { "Strongly Disagree": {REL: -1}, "Disagree": {REL: -0.5}, "Neutral": {REL: 0}, "Agree": {REL: 0.5}, "Strongly Agree": {REL: 1} } }
];
...
let userAnswers = []; // History stack to support 'Previous' action
...
function showResults() {
  ...
  Object.keys(maxPossibleScores).forEach(axis => {
    ...
    row.innerHTML = `<span><strong>${axis}</strong></span> <span>${scaled >= 0 ? '+' : ''}${formatted}</span>`;
